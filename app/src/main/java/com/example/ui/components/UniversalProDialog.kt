    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                Text(
                    text = "В демо доступны локальный каталог, склады и основные операции. Облачная синхронизация, несколько устройств, выгрузка отчётов и расширенные заявки доступны в PRO.",
                ...
                if (!backendConfigured) {
                    Text(
                        text = "Сервер оплаты ещё не привязан к этой тестовой APK. Покупка будет включена после финальной привязки адреса Worker.",
