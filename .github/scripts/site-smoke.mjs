...
if (!index.includes('v3.6.1') && !index.includes('3.6.1')) fail('site version 3.6.1 is not visible');
if (!index.includes('сборка 34') && !index.includes('Сборка 34') && !index.includes('data-release-code>34</span>')) fail('site build 34 marker is missing');
...
if (releaseManifest.versionName !== '3.6.1' || Number(releaseManifest.versionCode) !== 34) fail('release.json current release metadata is wrong');
...
if (releaseManifest.apkSha256 !== 'f1bddc1f57d88154af27be3e1f091551c61e4bebdcbcdca06daff9ef349705ba') fail('release.json APK hash changed unexpectedly');
