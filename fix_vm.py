...
content = content.replace('com.example.data.local.InitialData.defaultCategories', 'com.example.data.local.InitialData.getDefaultCategories(com.example.util.AppTerminology.getMode(application))')
