...
function trackApkDownload(source) {
  ...
  showToast('📥 Скачивание APK-файла «Каптёрка Про v3.4.7» началось...');
}
